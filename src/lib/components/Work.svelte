...
<div
	id="work"
	class="mt-48 mx-auto max-w-screen-lg py-96 2xs:py-48 xs:py-28 sm:py-24 md:py-20 lg:py-14"
>
	...
	{#each work as project, index (index)}
		<div class="project-container justify-items-end grid items-center gap-2 mb-10 mt-2">
			...
			>
				...
				<div
					class="z-2 content-desc relative scrollreveal rounded p-0 md:p-4 mt-4 text-gray-300 text-sm md:shadow-xl"
				>
					{project.description}
				</div>
			...
			<!-- media div -->
			<div
				class="z-1 scrollreveal h-full"
				class:picture-right={index % 2 === 1}
				class:picture-left={index % 2 === 0}
			>
				{#if project.img}
					<Media project>
						<img
